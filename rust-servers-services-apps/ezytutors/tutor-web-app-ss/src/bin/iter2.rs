...
mod tests {
    ...
    async fn handle_post_1_integration_test() {
        ...
        // init_service() creates an Actix Service for testing. We can post HTTP messages to
        // this service to simulate a web client sending a request to the web server. It takes a
        // regular app builder as a parameter, so we can pass the Tera instance and application
        // routes to it like we do for a regular Actix web application.
        //
        let app =
