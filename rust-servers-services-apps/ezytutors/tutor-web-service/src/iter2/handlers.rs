...
mod tests {
    ...
    async fn get_all_courses_success() {
        ...
        // In an end-to-end test, the application state would be passed by the Actix Web framework to
        // the handler function automatically. Here, in unit-test code, we have to do this step manually.
        ...
        // In an end-to-end test, the Actix framework deserializes the incoming HTTP
        // request parameters and passes them to the handler function. Here, in unit-test
        // code, we have to do this step manually.
